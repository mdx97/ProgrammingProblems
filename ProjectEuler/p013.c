 ...
 * File: Problem 13 (Large sum)
 * Description: Adds 100 50 digit numbers and prints the sum.
 */
#include <stdio.h>
#include <stdlib.h>
#include "numbers.h"
...
{
    int* sum = (int*)malloc(50 * sizeof(int));
    int size = 50;
    int i;
    ...
    for (i = 1; i < 100; i++)
    {
        huge_add_huge(&sum, &size, NUMBERS[i], 50);
    }

    int* first_ten = (int*)malloc(10 * sizeof(int));
